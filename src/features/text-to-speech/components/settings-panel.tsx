...
const tabTriggerClassName = `flex-1 h-full gap-2 bg-transparent rounded-none border-x-0 border-t-0 border-b-px 
border-b-transparent shadow-none data-[state=active]:border-b-foreground 
...
export function SettingsPanel() {
  return (
    <div className="hidden w-105 min-h-0 flex-col border-l lg:flex">
      ...
      >
        <TabsList
          className="w-full bg-transparent rounded-none border-b h-12 
