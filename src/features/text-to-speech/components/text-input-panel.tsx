    ...
    <div className="flex h-full min-h-0 flex-col flex-1">
      <div className="relative h-[600px]">
        <form.Field name="text">
          ...
          lg:pb-8 text-base! leading-relaxed tracking-tight shadow-none wrap-break-word
        ...
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 h-8 bg-linear-to-t 
